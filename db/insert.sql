...
INSERT INTO photos(id, imagename)
VALUES (1, 'nameFhoto.jpg');

INSERT INTO cars(id, mark, bodytype, engine, transmission, color, drive, mileage)
...
INSERT INTO posts(id, header, description, price, status, created, car_id, photo_id, user_id)
