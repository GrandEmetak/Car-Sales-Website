                ...
                <form action="<%=request.getContextPath()%>/candidate.do?id=<%=post.getId()%>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="textarea" class="form-control" name="position" value="<%=post.getDescription()%>"
                                   id="description"
                        ...
                        <div class="col-md-3 mb-3">
                            <label for="validation03">Engine</label>
                        ...
                        <div class="col-md-3 mb-3">
                            <label for="validation04">Transmission</label>
                            <select class="custom-select" id="validation04" required>
                                <option selected disabled value="">Choose...</option>
                                <option>automate</option>
                                <option>cvc</option>
                                <option>manual</option>
                        ...
                        <div class="col-md-3 mb-3">
                            <label for="validation05">Drive</label>
                            <select class="custom-select" id="validation05" required>
                                <option selected disabled value="">Choose...</option>
                        ...
                        <div class="col-md-6 mb-3">
                            <label>Mileage</label>
                            <input type="text" class="form-control" name="mileage" value="<%=post.getCar().getMileage()%>"
                                   id="mileage"
